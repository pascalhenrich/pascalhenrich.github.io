...
class PuzzlePiece {
    ...
    snap(piecePosition) {
        let position = findNearesGridPlace(piecePosition);
        if (position != null) {
 ...
 */
function getPieceOutOfGrid(mousePosition) {
 ...
 * @returns Position
 */
function findNearesGridPlace(mousePosition) {
